...
<aside class="sidebar">
  <div class="marca">
    ...
    <div class="texto">Portal de Notas<span>Panel del Profesor</span></div>
  ...
  <nav>
    ...
    <a href="estudiantes.php" class="<?= $pagina === 'estudiantes.php' ? 'activo' : '' ?>">
      <svg class="lucide" data-lucide="graduation-cap"></svg><span class="etiqueta">Mis Alumnos</span>
    </a>
    <a href="notas.php" class="<?= $pagina === 'notas.php' ? 'activo' : '' ?>">
      <svg class="lucide" data-lucide="star"></svg><span class="etiqueta">Calificaciones</span>
    </a>
    ...
    <a href="conducta.php" class="<?= $pagina === 'conducta.php' ? 'activo' : '' ?>">
      <svg class="lucide" data-lucide="shield"></svg><span class="etiqueta">Conducta</span>
    </a>
